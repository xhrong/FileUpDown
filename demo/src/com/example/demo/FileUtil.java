...
public class FileUtil {
    ...
    public static void moveFile(String sourceFilePath, String destFilePath) {
        if (isEmptyString(sourceFilePath) || isEmptyString(destFilePath)) {
    ...
    public static boolean isDirExist(String directoryPath) {
        if (isBlankString(directoryPath)) {
            return false;
        }
     ...
     */
    private static boolean isEmptyString(CharSequence str) {
