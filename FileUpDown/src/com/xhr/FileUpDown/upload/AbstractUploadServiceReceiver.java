    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null) {
            if (UploadService.getActionBroadcast().equals(intent.getAction())) {
                final int status = intent.getIntExtra(UploadStatus.STATUS, 0);
                ...
                switch (status) {
                    case UploadStatus.STATUS_ERROR:
                        ...
                        break;
                    case UploadStatus.STATUS_CANCEL:
                        final Exception ex = (Exception) intent
                                .getSerializableExtra(UploadService.CANCEL_EXCEPTION);
                        onCancel(uploadId, ex);
                        break;
                    ...
                    case UploadStatus.STATUS_IN_PROGRESS:
